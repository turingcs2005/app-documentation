...
const appDocumentationSchema = new mongoose.Schema({
    project: {
        projectName: String,    // e.g. Facultative Reinsurance Spreaders
        owner: String,          // e.g. Ryan D'entremonte
...
module.exports = mongoose.model('appDocumentation', appDocumentationSchema, 'app_data');